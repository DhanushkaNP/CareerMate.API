...
using CareerMate.EndPoints.Commands.Supervisors.Create;
using CareerMate.EndPoints.Commands.Supervisors.Delete;
using CareerMate.EndPoints.Commands.Supervisors.Update;
