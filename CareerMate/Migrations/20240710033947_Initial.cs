        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "text", nullable: true),
                    WorkPlaceType = table.Column<int>(type: "integer", nullable: false),
                    FlyerUrl = table.Column<string>(type: "text", nullable: true),
                    ...
                    PostedCoordinatorId = table.Column<Guid>(type: "uuid", nullable: true),
                    PostedCoordinatorAssistantId = table.Column<Guid>(type: "uuid", nullable: true),
                    FacultyId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
